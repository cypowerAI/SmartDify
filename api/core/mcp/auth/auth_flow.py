...
def discover_protected_resource_metadata(
    ...
    headers = {"MCP-Protocol-Version": protocol_version or LATEST_PROTOCOL_VERSION, "User-Agent": "SmartDify"}
...
def check_support_resource_discovery(server_url: str) -> tuple[bool, str]:
    ...
    try:
        headers = {"MCP-Protocol-Version": LATEST_PROTOCOL_VERSION, "User-Agent": "SmartDify"}
