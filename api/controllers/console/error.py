...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "SmartDify has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403
...
class NotSetupError(BaseHTTPException):
    ...
    description = (
        "SmartDify has not been initialized and installed yet. "
