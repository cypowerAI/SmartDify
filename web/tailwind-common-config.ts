...
const config = {
  theme: {
    ...
    extend: {
      colors: {
        gray: {
          25: 'var(--color-background-body)',
          50: 'var(--color-background-default-subtle)',
          100: 'var(--color-components-card-bg)',
          200: 'var(--color-components-card-bg-alt)',
          300: 'var(--color-components-panel-on-panel-item-bg)',
