  ...
  describe('Complete Workflows', () => {
    ...
    it('should render complete QA chunking workflow', () => {
      const qaChunks = createQAChunks({
        qa_chunks: [
          {
            question: 'What is SmartDify?',
            answer: 'SmartDify is an open-source LLM application development platform.',
          },
          {
      ...
      expect(screen.getByText('What is SmartDify?')).toBeInTheDocument()
      expect(screen.getByText('SmartDify is an open-source LLM application development platform.')).toBeInTheDocument()
