...
function createQA(overrides: Partial<QA> = {}): QA {
  return {
    ...
    answer: 'SmartDify is an open-source LLM app development platform.',
    ...overrides,
  }
}
...
describe('QAPreview', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render the answer text', () => {
      ...
      expect(screen.getByText('SmartDify is an open-source LLM app development platform.')).toBeInTheDocument()
    })
