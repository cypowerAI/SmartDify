...
describe('SuggestedQuestions', () => {
  ...
  const mockItem: IChatItem = {
    ...
    suggestedQuestions: ['What is SmartDify?', 'How to use it?', '  ', ''],
  }
  ...
  it('should render suggested questions and filter out empty ones', () => {
    ...
    expect(questions[0]).toHaveTextContent('What is SmartDify?')
  ...
  it('should call onSend when a question is clicked', async () => {
    ...
    expect(mockOnSend).toHaveBeenCalledWith('What is SmartDify?')
  })
