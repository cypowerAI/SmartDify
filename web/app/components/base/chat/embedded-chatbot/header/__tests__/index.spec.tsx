...
describe('EmbeddedChatbot Header', () => {
  ...
  describe('Desktop Rendering', () => {
    ...
    it('should render SmartDify logo by default when branding enabled is true but no logo provided', () => {
      vi.mocked(useGlobalPublicStore).mockImplementation((selector: (s: GlobalPublicStoreMock) => unknown) => selector({
        systemFeatures: {
          ...defaultSystemFeatures,
          branding: {
      ...
      render(<Header title="Test Chatbot" />)
      expect(screen.getByAltText('SmartDify logo')).toBeInTheDocument()
    })

    it('should render SmartDify logo when branding is disabled', () => {
      vi.mocked(useGlobalPublicStore).mockImplementation((selector: (s: GlobalPublicStoreMock) => unknown) => selector({
        systemFeatures: {
          ...defaultSystemFeatures,
          branding: {
