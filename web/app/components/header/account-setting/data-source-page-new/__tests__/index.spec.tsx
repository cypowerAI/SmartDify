...
describe('DataSourcePage Component', () => {
  const mockProviders: DataSourceAuth[] = [
    {
      ...
      icon: 'icon-1',
      name: 'SmartDify Source',
      label: { en_US: 'SmartDify Source', zh_Hans: 'zh_hans_dify_source' },
      description: { en_US: 'SmartDify Description', zh_Hans: 'zh_hans_dify_description' },
      credentials_list: [],
    },
    {
      author: 'Partner',
  ...
  describe('Initial View Rendering', () => {
    it('should render an empty view when no data is available and marketplace is disabled', () => {
      ...
      // Assert
      expect(screen.queryByText('SmartDify Source')).not.toBeInTheDocument()
  ...
  describe('Data Source List Rendering', () => {
    it('should render Card components for each data source returned from the API', () => {
      ...
      // Assert
      expect(screen.getByText('SmartDify Source')).toBeInTheDocument()
