...
describe('Header', () => {
  ...
  it('should show default SmartDify logo when branding is enabled but no workspace_logo', () => {
    mockBrandingEnabled = true
  ...
  it('should show default SmartDify text when branding enabled but no application_title', () => {
    mockBrandingEnabled = true
    mockBrandingTitle = null
    mockBrandingLogo = null
    ...
    expect(screen.getByText('SmartDify')).toBeInTheDocument()
  })
